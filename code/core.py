...
class units:
    ...
    def take_photos(self):
        ...
        l1=Label(self.tk,text="Enter name")
        l1.place(x=100,y=100)
    
        e1=Entry(self.tk,width = 30)
        e1.place(x=180,y=100)
    
        #name=e1.get()
        Button(self.tk,text="Ok",width=10,command=take).place(x=200,y=140)
        ...
        for root, _dirs, files in os.walk(image_dir):
               for file in files:            
                    if file.endswith("png") or file.endswith("jpg"):
                        ...
                        faces = self.face_cascade.detectMultiScale(image_array, scaleFactor=1.01, minNeighbors=5)
